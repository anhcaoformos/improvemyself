...
public class PaymentMethodResource {
    ...
    public ResponseEntity<List<PaymentMethodDTO>> getAllPaymentMethods(
        ...
        if ("transaction-is-null".equals(filter)) {
            log.debug("REST request to get all PaymentMethods where transaction is null");
            return new ResponseEntity<>(paymentMethodService.findAllWhereTransactionIsNull(), HttpStatus.OK);
        }
