!(function (e, t) {
  ...
  var ee,
    ...
    re = {
      ...
      isStandardBrowserEnv:
        ('undefined' == typeof navigator || ('ReactNative' !== (ee = navigator.product) && 'NativeScript' !== ee && 'NS' !== ee)) &&
                        ...
                        (i = e) &&
                          i.split('\n').forEach(function (e) {
                            (u = e.indexOf(':')),
                              ...
                              !a ||
                                (c[a] && ue[a]) ||
                                ('set-cookie' === a ? (c[a] ? c[a].push(s) : (c[a] = [s])) : (c[a] = c[a] ? c[a] + ', ' + s : s));
                          }),
                        c),
                        t,
                      )
        ...
        function (t) {
          return (
            ye(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = me.call(e, e.transformResponse, t.response)), (t.response.headers = he.from(t.response.headers)))),
            Promise.reject(t)
          );
        },
      )
  ...
  Ce.transitional = function (e, t, n) {
    ...
    return function (n, o, i) {
      ...
      return (
        t && !xe[o] && ((xe[o] = !0), console.warn(r(o, ' has been deprecated since v' + t + ' and will be removed in the near future'))),
        !e || e(n, o, i)
      );
    };
  };
