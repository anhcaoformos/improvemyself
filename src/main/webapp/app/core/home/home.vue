<template>
  <div class="home row" v-if="hasNotAuthorities(['ROLE_USER', 'ROLE_ADMIN'])">
    <div class="col-md-3">
  ...
  <div class="home row" v-if="hasAnyAuthority('ROLE_ADMIN')">
    <div class="col-md-3">
      <span class="hipster img-fluid rounded"></span>
    </div>
    <div class="col-md-9">
  ...
  <div class="home" v-if="hasAnyAuthority('ROLE_USER')">
    <div class="row align-items-center justify-content-between">
      <div class="col-md-4">
        <h2 class="display-4">Ledger</h2>
      </div>
      <div class="col-md-4 text-end">
        <VueMultiselect
          :model-value="selectedUserLedger"
          :options="userLedgers"
          :searchable="false"
