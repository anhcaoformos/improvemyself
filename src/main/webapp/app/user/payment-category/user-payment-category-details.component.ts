...
import UserPaymentCategoryService from './user-payment-category.service';
...
export default defineComponent({
  ...
  setup() {
    const paymentCategoryService = inject('paymentCategoryService', () => new UserPaymentCategoryService());
