...
import UserSplitBookDetailService from './user-split-book-detail.service';
...
export default defineComponent({
  ...
  setup() {
    const splitBookDetailService = inject('splitBookDetailService', () => new UserSplitBookDetailService());
